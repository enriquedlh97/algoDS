...
from algosds.problems.patterns.miscellaneous.sorting.selection_sort import \
    selection_sort_two_for_loops, \
    selection_sort_while

myPath = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, myPath + '/../')

tests = [([8, 5, 2, 9, 5, 6, 3], [2, 3, 5, 5, 6, 8, 9]),
         ([1], [1]),
         ([1, 2], [1, 2]),
         ([2, 1], [1, 2]),
         ([1, 3, 2], [1, 2, 3]),
         ...
         ([544, -578, 556, 713, -655, -359, -810, -731, 194, -531, -685, 689, -279, -738, 886, -54, -320, -500, 738, 445, -401, 993, -753, 329, -396, -924, -975, 376, 748, -356, 972, 459, 399, 669, -488, 568, -702, 551, 763, -90, -249, -45, 452, -917, 394, 195, -877, 153, 153, 788, 844, 867, 266, -739, 904, -154, -947, 464, 343, -312, 150, -656, 528, 61, 94, -581],
...
def test_selection_sort_two_for_loops(array, answer):
    assert selection_sort_two_for_loops(array) == answer


@pytest.mark.parametrize("array, answer", tests)
def test_selection_sort_while(array, answer):
    assert selection_sort_while(array) == answer
