...
def test_bubble_sort_for_loop(array, answer):
    assert bubble_sort_for_loop(array) == answer


@pytest.mark.parametrize("array, answer", tests)
def test_bubble_sort_while(array, answer):
    assert bubble_sort_while(array) == answer


@pytest.mark.parametrize("array, answer", tests)
def test_bubble_sort_while_original(array, answer):
    assert bubble_sort_while_original(array) == answer
