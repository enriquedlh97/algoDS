...
def test_insertion_sort_two_for_loops(array, answer):
    assert insertion_sort_two_for_loops(array) == answer


@pytest.mark.parametrize("array, answer", tests)
def test_insertion_sort_while(array, answer):
    assert insertion_sort_while(array) == answer
